...
parser.add_argument("-c", "--config", help="Config file with dataset parameters", required=False)
...
parser.add_argument("-o", "--output_dir", help="Directory to save results", required=False)
