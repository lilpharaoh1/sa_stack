...
from igp2.core.vehicle import Action, Observation, TrajectoryVehicle, KinematicVehicle, TrajectoryPrediction
...
class TrajectoryAgent(Agent):
    ...
    def next_action(self, observation: Observation, prediction: TrajectoryPrediction = None) -> Optional[Action]:
