...
from igp2.core.vehicle import TrajectoryVehicle, Action, Observation, TrajectoryPrediction
...
class ManeuverAgent(Agent):
    ...
    def next_action(self, observation: Observation = None, prediction: TrajectoryPrediction = None) -> Action:
